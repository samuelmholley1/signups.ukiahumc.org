  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 print:px-0 print:py-0">
        ...
        {/* Section 1: Running Totals by Item */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8 print:shadow-none print:mb-6 print:break-after-page">
          <div className="flex justify-between items-center mb-4 print:mb-3">
            <h2 className="text-2xl font-bold text-gray-900 print:text-xl">1. Running Totals by Item</h2>
            <button
          ...
          {Object.entries(runningTotals).map(([category, items]) => (
            <div key={category} className="mb-6 print:mb-4">
              <h3 className="text-lg font-semibold text-gray-800 mb-2 print:text-base">{category}</h3>
                  ...
                  <tbody>
                    {items.map((item, idx) => (
                      <tr key={idx} className="hover:bg-gray-50 print:hover:bg-transparent">
                        <td className="border border-gray-300 px-4 py-2 text-sm print:px-2 print:py-1 print:text-xs">{category}</td>
